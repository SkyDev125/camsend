...
export const runHighSpeed = async ({ profile = "glyph6", bytes = 100_000, seed = 29, frameLoss = 0.08, duplicate = 0.05, maxFrames = 100, width = 1728, frameRate = 30, blockSize, impairment = {}, innerFec } = {}) => {
  ...
  const receiver = new FileReceiver({ innerFec: configuredInnerFec }); const started = performance.now(); let unique = 0; let rejected = 0; let duplicates = 0; let previous = null; let lastSequence = -1; const rejectionReasons = {}; let lastDiagnostics = null;
